                    ...
                    {[
                        ...
                        <tr key={item.id} className="hover:bg-g-gray-100">
                            ...
                            <td className="py-4 px-6 whitespace-nowrap">
                                <span className={`px-3 py-1 inline-flex text-label-12 font-semibold rounded-full ${item.status === 'Approved'
                                    ? 'bg-g-green-100 text-g-green-800' : item.status === 'Rejected' ? 'bg-g-red-100 text-g-red-800' : 'bg-g-amber-100 text-g-amber-800'}`}>
                                    {item.status}
                                </span>
                            </td>
                            <td className="py-4 px-6 whitespace-nowrap text-copy-14 text-g-gray-800">
