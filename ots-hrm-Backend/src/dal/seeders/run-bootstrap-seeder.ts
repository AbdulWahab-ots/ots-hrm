...
// Runs the legitimate system bootstrap (countries + privileges + super admin).
// This is NOT the dummy/test data seeder — it only creates real system data.
const runSeeder = async () => {
  ...
  try {
    ...
    console.error("❌ Bootstrap seeder failed:", err);
