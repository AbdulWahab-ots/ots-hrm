...
export interface IServiceBase<TRequest, TResponse, TQuery = TRequest> {
    ...
    getOneWithFilteredRelations(contextUser: ITokenUser, filtersRequest: IGetSingleRecordFilter<TRequest | TQuery>): Promise<TResponse | null>;
    ...
    getWithFilteredRelations(contextUser?: ITokenUser, fetchRequest?: IFetchRequest<TRequest>): Promise<IDataSourceResponse<TResponse>>;
}